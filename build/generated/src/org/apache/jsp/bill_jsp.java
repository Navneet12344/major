...
public final class bill_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 System.out.println("hiiiiiii=000000s");
      ...
      out.write("\n");
      out.write("        <h1 style=\"color: #007bff; font-size: 40px;\">Hotel Bill</h1>\n");
      out.write("        <h4>Name : ");
      out.print(session.getAttribute("uname"));
      out.write("</h4>\n");
      out.write("        <h4>Hotel Booked : ");
      out.print(h.getHotelname());
      out.write("</h4>\n");
      out.write("        <h4>Check_in : ");
      out.print(session.getAttribute("cin"));
      out.write("</h4>\n");
      out.write("        <h4>Check_out : ");
      out.print(session.getAttribute("cout"));
      out.write("</h4>\n");
      out.write("        <h4>Paid Amount : ");
      out.print(session.getAttribute("total"));
      out.write("</h4>\n");
      out.write("        <!--<a href=\"download?filename=\">Download</a>-->\n");
      out.write("    </body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
